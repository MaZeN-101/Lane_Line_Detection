...
Prcoess_video('project_video.mp4',debug = 1 , resize_param = 0.75 , save = 1, show = 1)
...
#take arguments from terminal
  def play_video():
    ...
    depug = input("enter debugging mode : ")
    resize_param = input("enter resize_param : ")
    save = input("enter save mode (1 => save) : ")
    show = input("enter show mode (1 => show): ")
